...
namespace tavelapp
{
    public partial class CarBooking : Form
    {
        ...
        void loadData()
        {
            ...
            {
                flowLayoutPanel1.Controls.Add(CreatePanel(dt.Rows[i][1].ToString(), dt.Rows[i][3].ToString(), dt.Rows[i][6].ToString(), dt.Rows[i][0].ToString()));

            }
        }
        private Panel CreatePanel(string name, string Price, string Img, string Cid)
        {
            ...
            {
                CarDetail car = new CarDetail(int.Parse(Cid));
                this.Hide();
                car.ShowDialog();
                this.Show();
