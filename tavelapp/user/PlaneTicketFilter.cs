...
namespace tavelapp
{
    public partial class PlaneTicketFilter : Form
    {
        
        public PlaneTicketFilter()
        {
            InitializeComponent();
             loadData();
        ...
        {
            PlaneTicket p = new PlaneTicket(ddlfrom.SelectedItem.ToString(),ddlto.SelectedItem.ToString(),ddldate.SelectedItem.ToString());
            this.Hide();
            p.ShowDialog();
            this.Show();
        }
